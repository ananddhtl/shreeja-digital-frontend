...
const CTA = () => {
  ...
  return (
    <section className="px-4 py-20 bg-white">
      <div className="max-w-7xl mx-auto bg-gradient-to-r from-purple-500 to-blue-500 text-white text-center rounded-2xl px-8 py-20 shadow-lg">
        <h2 className="text-xl sm:text-3xl font-bold mb-4 whitespace-nowrap overflow-hidden text-ellipsis">
          Ready to Transform Your{' '}
          <span className="relative inline-block align-middle w-[15ch]">
            <span className="invisible">{longestWord}</span>
            <span
              key={index}
              className="absolute top-0 left-0 w-full animate-fadeFromBottom text-transparent bg-clip-text bg-gradient-to-r from-amber-400 via-orange-500 to-red-500 text-left"
            >
              {rotatingWords[index]}
            </span>
          </span>
